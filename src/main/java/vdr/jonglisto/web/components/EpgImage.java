...
public class EpgImage extends BaseComponent {
    ...
    public Link getEpgImageLink() {
        if (scraper) {
            ...
            case Movie:
                return componentResources.createEventLink("movieMediaImage", imageKey.getMovieId(),
                        imageKey.getActorId(), imageKey.getMediaType());

            case Series:
                return componentResources.createEventLink("seriesMediaImage", imageKey.getSeriesId(),
                        imageKey.getSeasonNumber(), imageKey.getEpisodeId(), imageKey.getActorId(),
                        imageKey.getMediaType());
