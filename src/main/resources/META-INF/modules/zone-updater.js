...
define(["jquery", "t5/core/zone"], function($, zoneManager) {
    ...
    return function(elementId, clientEvent, listenerURI, zoneElementId, addElement) {
        ...
        function updateZone() {
            ...
            // if ($element.val()) {
                ...
                listenerURIWithValue = appendQueryStringParameter(listenerURIWithValue, 'param', $element.val(), addvalue);
            //}
